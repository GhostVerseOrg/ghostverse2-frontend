...
import { PrivacyPolicyApi } from '@/app/_lib/api/PrivacyPolicy';
...
export default async function Page({
  ...
  const legalsData = await getPrivacyPolicyContent(locale);
...
const getPrivacyPolicyContent = async (locale: any) => {
  const [legalsData] = await Promise.all([
    PrivacyPolicyApi.getPrivacyPolicyContent(locale),
  ]);
