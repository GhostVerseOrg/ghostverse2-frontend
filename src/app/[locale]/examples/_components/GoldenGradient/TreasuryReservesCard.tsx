...
> = async ({ treasuryFunds }) => {
  ...
  return (
    <div className="w-full max-w-xs bg-colr-l-primary bg-opacity-100 backdrop-filter backdrop-blur-md rounded-lg shadow-lg p-4 text-white flex flex-col items-center">
