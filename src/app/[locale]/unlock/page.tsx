  ...
  return (
    <AuthRedirectWrapper requireAuth={false}>
      <div className="flex justify-center items-center h-screen bg-colr-d-bg">
        <Link
          href="/"
          className="absolute top-10 right-10 text-colr-mvx-teal text-4xl p-2 inline-flex w-12 h-12 items-center justify-center bg-colr-ghostverse-teal rounded-full z-50"
        >
          <XMarkIcon />
        </Link>
        <div
